...
public class ToolMaterialsTFCM {
    ...
    public static final Item.ToolMaterial NICKEL_SILVER = EnumHelper.addToolMaterial("tfcm_nickel_silver", 2, 2500, 12,
            4.75f, 12);
    ...
    public static final Item.ToolMaterial MANYULLYN = EnumHelper.addToolMaterial("tfcm_manyullin", 4, 1000, 15, 7.0f,
            18);
    ...
    public static final Item.ToolMaterial TUNGSTEN = EnumHelper.addToolMaterial("tfcm_tungsten", 4, 6600, 18, 10.0f,
            24);
    public static final Item.ToolMaterial TUNGSTEN_STEEL = EnumHelper.addToolMaterial("tfcm_tungsten_steel", 5, 9200,
            20, 11.5f, 24);
    ...
    public static final Item.ToolMaterial BERYLLIUM_COPPER = EnumHelper.addToolMaterial("tfcm_beryllium_copper", 4,
            9000, 8, 7.9f, 26);
    ...
    public static final Item.ToolMaterial ENDERIUM = EnumHelper.addToolMaterial("tfcm_enderium", 5, 6800, 16, 12.0f,
            28);
    public static final Item.ToolMaterial FLUXED_ELECTRUM = EnumHelper.addToolMaterial("tfcm_fluxed_electrum", 5, 6800,
            16, 12.0f,
            28);
}
