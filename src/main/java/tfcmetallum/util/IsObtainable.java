...
public class IsObtainable {
    ...
    public static void checkObtanability() {
        if (ConfigTFCM.METALS.ardite && ConfigTFCM.RECIPES.ardite && ConfigTFCM.METALS.cobalt &&
                ConfigTFCM.RECIPES.cobalt && ConfigTFCM.METALS.manyullyn) {
            manyullyn = true;
        }
        ...
        if (ConfigTFCM.METALS.aluminium && ConfigTFCM.RECIPES.aluminium && ConfigTFCM.METALS.beryllim &&
                ConfigTFCM.METALS.beryllim_copper) {
